...
[Vanderlinde dos Santos (2019)](#citation) Dr. jaclyn Caccese on repetitive head impacts and
...
The filename has **five fields separated by underscores**, plus a fixed
prefix and suffix. Notice that **Group** and **Timepoint** are *two
different fields* — don't combine them.

Worked example: `CAVE_Concussion_023_SubAcute_4_-_COP.txt` parses as
...
| 6 | `_-_COP.txt` | fixed suffix | exactly this — note the underscores around the dash |

A few correctly-named examples:

```
CAVE_Control_001_Acute_3_-_COP.txt        ← Control subject 1, Acute timepoint, walking trial 3
CAVE_Concussion_017_Chronic_7_-_COP.txt   ← Concussion subject 17, Chronic timepoint, standing trial 7
CAVE_Control_042_SubAcute_5_-_COP.txt     ← Control subject 42, SubAcute timepoint, walking trial 5
```
